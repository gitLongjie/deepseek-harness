...
| [knowledge-base.md](knowledge-base.zh.md) | 企业知识库接缝：`KnowledgeBaseId`/`View`、文档列举与分页，以及 `ctx.knowledgeBase` 服务 |
| [market.md](market.zh.md) | 插件市场：品牌化的来源/条目/bundle 标识、来源注册表与目录传输、npm 身份可安装性，以及 profile 安装结果 |
