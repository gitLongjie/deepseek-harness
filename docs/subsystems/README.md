...
| [knowledge-base.md](knowledge-base.md) | the enterprise knowledge-base seam: `KnowledgeBaseId`/`View`, document listing and paging, and the `ctx.knowledgeBase` service |
| [market.md](market.md) | the plugin market: branded source/entry/bundle ids, the source registry and catalog transports, npm-identity installability, and profile install outcomes |
