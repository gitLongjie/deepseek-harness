...
export const zh = {
  ...
  'menu.revealInExplorer': '在资源管理器中打开',
  ...
  'delete.desc': '将把“{name}”从工作区列表中移除。文件夹与会话记录会保留，其会话将归档，不再显示在列表中。',
...
export const en = {
  ...
  'menu.revealInExplorer': 'Open in File Explorer',
  ...
  'delete.desc': 'This removes “{name}” from the workspace list. The folder and session logs will be kept. Its sessions will be archived and no longer listed.',
