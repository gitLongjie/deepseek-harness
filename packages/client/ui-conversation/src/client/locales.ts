...
export const zh = {
  ...
  'notification.error': '对话出错：{message}',
  'notification.waitingAnswer': '等待回答',
  ...
  'drop.desc': '图片最多 {count} 张，每张 {size}',
  'drop.blocked': '当前无法添加附件',
  'file.importFailed': '{name} 导入失败：{reason}',
  'file.insertFailed': '{name} 已导入，但无法插入输入框',
  'file.importUnavailable': '当前环境不支持添加文件',
  'image.pending': '待发送图片',
  ...
  'settings.business.title': '业务入口',
  'settings.business.visibility': '显示业务入口',
  'settings.business.description': '在侧边栏显示部署的业务入口分组',
  ...
  'access.readOnlyLabel': '只读',
  'access.workspaceWriteLabel': '工作区写入',
  'access.fullLabel': '完全访问',
  'hero.greeting.morning': '早上好，去探索未至之境',
  'hero.greeting.noon': '中午好，去探索未至之境',
  'hero.greeting.afternoon': '下午好，去探索未至之境',
  'hero.greeting.evening': '晚上好，去探索未至之境',
  'hero.greeting.night': '深夜好，去探索未至之境',
...
export const en = {
  ...
  'notification.error': 'Conversation error: {message}',
  'notification.waitingAnswer': 'Waiting for your answer',
  'placeholder.steerQueue': 'Cmd/Ctrl+Enter steers all queued messages',
  'input.commands': 'Commands',
  'input.add': 'Add',
  'input.addFile': 'Add files',
  'input.stop': 'Stop generating',
  'input.send': 'Send message',
  'input.accessMode': 'Access mode, current: {name}',
  'drop.title': 'Drag images or files here to add them',
  'drop.desc': 'Up to {count} images, {size} each',
  'drop.blocked': 'Attachments cannot be added right now',
  'file.importFailed': 'Failed to import {name}: {reason}',
  'file.insertFailed': '{name} was imported but could not be inserted into the draft',
  'file.importUnavailable': 'Adding files is not supported in this environment',
  ...
  'settings.business.title': 'Business entries',
  'settings.business.visibility': 'Show business entries',
  'settings.business.description': 'Show the business entries group in the sidebar',
  ...
  'access.readOnlyLabel': 'Read Only',
  'access.workspaceWriteLabel': 'Workspace Write',
  'access.fullLabel': 'Full access',
  'hero.greeting.morning': 'Good morning. Explore the unexplored.',
  'hero.greeting.noon': 'Good afternoon. Explore the unexplored.',
  'hero.greeting.afternoon': 'Good afternoon. Explore the unexplored.',
  'hero.greeting.evening': 'Good evening. Explore the unexplored.',
  'hero.greeting.night': 'Burning the midnight oil. Explore the unexplored.',
