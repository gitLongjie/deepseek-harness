...
import {
  IconChevronDownOutline14, IconFolderClose16, IconFolderOpen16, MewoLogo,
    ...
    <div className={css.root}>
      <div className={css.stack}>
        <div className={css.headline}>
          {/* Brand mark leading the headline at 34px wide, gap 10. */}
          <span className={css.markHitbox}>
            {renderSlot('conversation.hero.brand.mark', { size: 34, className: css.mark }, {
              fallback: <MewoLogo size={34} className={css.mark} />,
            })}
          </span>
