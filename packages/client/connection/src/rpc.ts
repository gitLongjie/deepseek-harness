...
/** Authority the channel's Fetch dispatch applies to requests. */
export type ConnectionRpcAuthority = 'loopback' | 'trusted-host'
...
export interface HostConnectionRpc {
   ...
   * @param options - dispatch options; `authority` defaults to `'trusted-host'`.
...
export interface HostConnectionHandle {
   ...
   * @param fallback - handler for endpoints neither the routes nor the
   * interceptor claim; defaults to a 404 response.
