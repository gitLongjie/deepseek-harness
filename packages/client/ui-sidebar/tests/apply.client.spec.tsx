...
describe('ui-sidebar apply', () => {
  ...
  it('registers the shell and declares its child seats', async () => {
    ...
    expect(b.slots.spec('sidebar.knowledge')).toEqual({ kind: 'single', scope: 'root' })
    expect(b.slots.spec('sidebar.workspaces')).toEqual({ kind: 'single', scope: 'root' })
    expect(b.slots.spec('sidebar.business')).toEqual({ kind: 'single', scope: 'root' })
  ...
  it('removes the entry and child declaration on teardown', async () => {
    ...
    expect(b.slots.spec('sidebar.knowledge')).toBeUndefined()
    expect(b.slots.spec('sidebar.workspaces')).toBeUndefined()
    expect(b.slots.spec('sidebar.business')).toBeUndefined()
