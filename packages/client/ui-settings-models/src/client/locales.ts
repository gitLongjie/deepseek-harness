...
export const en = {
  ...
  modelInputInvalid: 'Input types must include text and may include image.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  modelInputInvalid: '输入类型必须包含文本，且只能额外包含图片。',
