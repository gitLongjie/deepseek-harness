...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  {
    key: 'conversation.expert.browser',
    kind: 'single',
    scope: 'root',
    summary: 'The expert page (market cards beside hire affordances), replacing the session/hero content while open.',
    doc: 'The expert page (market cards beside hire affordances), replacing the\nsession/hero content while open.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    declaredBy: 'an entry in \'main.conversation\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-expert ExpertBrowser',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  {
    key: 'conversation.knowledge.browser',
    kind: 'single',
    scope: 'root',
    summary: 'The knowledge page (base list beside the document browser), replacing the session/hero content while open.',
    doc: 'The knowledge page (base list beside the document browser), replacing\nthe session/hero content while open.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    declaredBy: 'an entry in \'main.conversation\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-knowledge-base KnowledgeLibrary',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-schedule-work ScheduleWorkPage',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    occupants: [
      'client-ui-settings-market MarketSettingsTab id \'market\'',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-conversation BusinessSection id \'business-entries\'',
  ...
  {
    key: 'sidebar.business',
    kind: 'single',
    scope: 'root',
    summary: 'The deployment\'s business-entry links rendered between the expert section and the workspace section.',
    doc: 'The deployment\'s business-entry links rendered between the expert\nsection and the workspace section. Declared by this package\'s \'sidebar\'\nentry; the business-entry plugin registers its occupant.',
    registerOptions: [],
    ownerProps: [
    ...
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'sidebar.business\', () => ctx.slots.register(\n      { name: \'sidebar.business\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'sidebar\' (client-ui-sidebar), so it exists while that entry is mounted',
    occupants: [
      'client-ui-knowledge-base KnowledgeNav',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'sidebar\' (client-ui-sidebar), so it exists while that entry is mounted',
    occupants: [
      'client-ui-schedule-work ({ size }: { size: number; active: boolean }) => createEl…',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    source: 'packages/client/ui-sidebar/src/client/contract/slots.ts:66',
  },
  {
