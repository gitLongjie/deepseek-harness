...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'The business-entry section rendered below the workspace region: the deployment\'s own task entries as one collapsible group.',
    doc: 'The business-entry section rendered below the workspace region: the\ndeployment\'s own task entries as one collapsible group. Declared by this\npackage\'s \'sidebar\' entry; optional — a deployment without business\nentries registers no occupant and the region renders without the\nsection.',
    registerOptions: [],
    ownerProps: [
