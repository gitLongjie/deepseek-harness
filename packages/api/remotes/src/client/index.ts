...
import kbGatewayRemote from '@deepseek-ai/dsh-kb-gateway/remote'
import marketRemote from '@deepseek-ai/dsh-market-gateway/remote'
...
import scheduleWorkRemote from '@deepseek-ai/dsh-schedule-work/remote'
...
export type {} from '@deepseek-ai/dsh-kb-gateway/remote'
export type * from '@deepseek-ai/dsh-kb-gateway/types'
export type {} from '@deepseek-ai/dsh-market-gateway/remote'
export type * from '@deepseek-ai/dsh-market-gateway/types'
...
export type {} from '@deepseek-ai/dsh-schedule-work/remote'
export type * from '@deepseek-ai/dsh-schedule-work/types'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      ...
      pluginInventoryRemote, kbGatewayRemote, marketRemote, messageFeedbackRemote, sessionFeedbackRemote,
      fileUploadsRemote, sessionReferencesRemote, permissionPresetsRemote, subagentsRemote, sessionRemote,
      workspaceRemote, workspaceFilesRemote, terminalRemote, scheduleWorkRemote,
    ]) {
