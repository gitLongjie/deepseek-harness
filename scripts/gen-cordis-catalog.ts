...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  launcherProfile: 'not a service: launcher-provided boot-context value (string | undefined) naming the running profile — packages/boot/cmdline/README.md owns this launcher contract',
  ...
  uiKnowledge: 'client-side knowledge-browser navigation adapter — packages/client/ui-knowledge-base/README.md owns the API',
  uiAgentPreset: 'client-side agent-preset staging navigation adapter — packages/client/ui-agent-preset/README.md owns the API',
  uiExpert: 'client-side expert-browser navigation adapter — packages/client/ui-expert/README.md owns the API',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  FileImportRequest: 'session-reference.md',
  FileImportValue: 'session-reference.md',
  ...
  JobId: 'jobs.md',
  JobRead: 'jobs.md',
  KnowledgeBaseId: 'knowledge-base.md',
  KnowledgeBaseView: 'knowledge-base.md',
  KnowledgeDocumentId: 'knowledge-base.md',
  KnowledgeDocumentKind: 'knowledge-base.md',
  KnowledgeDocumentContent: 'knowledge-base.md',
  KnowledgeDocumentPage: 'knowledge-base.md',
  KnowledgeDocumentView: 'knowledge-base.md',
  JobSnapshot: 'jobs.md',
  JobStart: 'jobs.md',
  JobsChangedListener: 'jobs.md',
  MarketAttribution: 'market.md',
  MarketBrowseQuery: 'market.md',
  MarketBundleId: 'market.md',
  MarketCatalogEntry: 'market.md',
  MarketCatalogPage: 'market.md',
  MarketEntryId: 'market.md',
  MarketEntryRef: 'market.md',
  MarketInstallability: 'market.md',
  MarketInstallOutcome: 'market.md',
  MarketInstallSuccess: 'market.md',
  MarketInstalledPlugin: 'market.md',
  MarketOperationFailure: 'market.md',
  MarketSource: 'market.md',
  MarketSourceId: 'market.md',
  MarketSourceInput: 'market.md',
  MarketSourceKind: 'market.md',
  MarketUninstallOutcome: 'market.md',
  MarketUninstallSuccess: 'market.md',
