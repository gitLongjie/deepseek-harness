...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-schedule-work': { kind: 'indirect', reason: 'The page edits durable task records; the schedule-work runtime that dispatches them owns every model-facing effect.' },
  ...
  'packages/kb/kb': { kind: 'indirect', reason: 'The service contract registers no prompt, tool schema, or event payload; gateway and web consumers own every projection.' },
